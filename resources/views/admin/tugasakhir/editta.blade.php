...
<section id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Ubah Data TA</h5>
                    <ol class="breadcrumbs">
                        <li>
                            <a href="{{url('admin')}}">Dashboard</a>
                        </li>
                        <li>
                            <a href="{{url('admin/ta')}}">Daftar TA</a>
                        </li>
                        <li class="active">Ubah Data TA</li>
                    </ol>
                </div>
    ...
    <div id="responsive-table">
        <h4 class="header">Ubah Data Tugas Akhir Mahasiswa Fakultas Ilmu Komputer</h4>
        <div class="row">
            <div class="col s12">
