...
<section id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Ubah Data PKL</h5>
                    <ol class="breadcrumbs">
                        <li>
                            <a href="{{url('admin')}}">Dashboard</a>
                        </li>
                        <li>
                            <a href="{{url('admin/pkl')}}">Daftar PKL</a>
                        </li>
                        <li class="active">Ubah Data PKL</li>
                    </ol>
                </div>
    ...
    <div id="responsive-table">
        <h4 class="header">Ubah Data PKL Mahasiswa Fakultas Ilmu Komputer</h4>
        <div class="row">
            <div class="col s12">
