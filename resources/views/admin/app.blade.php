...
<html lang="en">
    ...
    <head>
        ...
        <!-- For Windows Phone -->
        <!-- CORE CSS-->
        <link href="assets/admin/css//materialize.css" type="text/css" rel="stylesheet">
        <link href="assets/admin/css//style.css" type="text/css" rel="stylesheet">
        <!-- Custome CSS-->
        <link
            href="assets/admin/css/custom/custom.css"
            type="text/css"
            rel="stylesheet">
        <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
        <link
            href="assets/admin/vendors/perfect-scrollbar/perfect-scrollbar.css"
            type="text/css"
            rel="stylesheet">
        <link
            href="assets/admin/vendors/flag-icon/css/flag-icon.min.css"
            type="text/css"
            rel="stylesheet">
    </head>
    <body>
                            ...
                            <li>
                                <a
                                    ...
                                    <span class="avatar-status avatar-online">
                                        <img src="assets/admin/images/avatar/avatar-7.png" alt="avatar">
                                        <i></i>
                                    </span>
                                </a>
                            </li>
                    ...
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        <li class="user-details cyan darken-2">
                            <div class="row">
                                <div class="col col s4 m4 l4">
                                    <img
                                        src="assets/admin/images/avatar/avatar-7.png"
                                        alt=""
                                ...
                                document.getElementById('logout-form').submit();">
                                    ...
                                    <a
                                        ...
                                        href="#" style="font-size:1.2vw;"
                                        data-activates="profile-dropdown-nav">{{ Auth::user()->name }}<i class="mdi-navigation-arrow-drop-down right"></i>
                                    </a>
                        ...
                        <li class="no-padding">
                            <ul class="collapsible" data-collapsible="accordion">
                                ...
                                <li class="bold">
                                    <a href="barang.html" class="waves-effect waves-cyan">
                    ...
                    <div class="container">
                        ...
                        <div id="card-widgets">
                            <div class="row show-on-medium-and-up">
                                <div class="col s12 m12 l12 center">
                                    <h5>Welcome {{ Auth::user()->name }} to the admin panel page. Have a nice day Sir!.</h5>
                                </div>
                            </div>
                        </div>
                        <div id="card-stats">
                        ...
                        <div id="card-widgets">
                            <div class="row hide-on-med-and-down">
                                <div class="col s12 m12 l12 center">
                                    <h4>Welcome {{ Auth::user()->name }} to the admin panel page. Have a nice day Sir!.</h4>
                                </div>
                            </div>
                        </div>
                        <!-- 
        ...
        ================================================ -->
        <!-- jQuery Library -->
        <script type="text/javascript" src="assets/admin/vendors/jquery-3.2.1.min.js"></script>
        <!--materialize js-->
        <script type="text/javascript" src="assets/admin/js/materialize.min.js"></script>
        <!--scrollbar-->
        <script
            type="text/javascript"
            src="assets/admin/vendors/perfect-scrollbar/perfect-scrollbar.min.js"></script>
        <!--plugins.js - Some Specific JS codes for Plugin Settings-->
        <script type="text/javascript" src="assets/admin/js/plugins.js"></script>
        <!--custom-script.js - Add your own theme custom JS-->
        <script type="text/javascript" src="assets/admin/js/custom-script.js"></script>
        <script>
        $(document.ready(function(){
          Materialize.toast('asda',4000)
        });
        </script>
    </body>
</html>